...
import { translateTrainingPlan } from '@/lib/actions/training-plan-translate';
import {
  formatReps,
  formatWeight,
  WEEKDAYS,
        ...
        <div className="flex items-start justify-between pb-5 border-b border-[#1F2733]">
          ...
          <div className="flex items-center gap-2.5">
            <button
              ...
              disabled={isPending}
              className="px-3 py-1.5 text-[11px] tracking-[1px] uppercase text-[#8FAAC6] hover:bg-[#8FAAC6]/10 border border-[#8FAAC6]/40 rounded disabled:opacity-50 transition-colors"
            >
              {isPending ? 'Übersetzt…' : 'Übersetzen'}
            </button>
